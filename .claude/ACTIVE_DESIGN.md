...
**NEXT（要ユーザー選択）: 次アーク — `docs/plans/slice-c-build-args.md` /
`docs/plans/gc-disk-usage.md`（PROPOSAL・open decisions 要回答）/ その他 roadmap。**
...
upstream 報告 = 保留（GA 後再訪）。次の入力待ち = 次アーク選択。
